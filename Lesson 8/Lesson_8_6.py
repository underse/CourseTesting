...
def main():
    ...
    print("""Извините, не сделал это задание. Надо JSON писать и чать из файла (или SQLITE3) для того чтобы результаты не потерялись.
    Понимание есть как сделать. Но пол-дня не был готов уже потратить.""")
